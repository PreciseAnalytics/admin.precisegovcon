...
import { Users, CreditCard, DollarSign, TrendingUp, Activity, UserCheck } from 'lucide-react';
      ...
      <div className="mt-6 bg-white rounded-xl border border-slate-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border-l-4 border-green-500 pl-4">
            <p className="text-sm text-slate-600 mb-1">Avg Revenue Per User</p>
            <p className="text-2xl font-bold text-slate-900">
          ...
          <div className="border-l-4 border-purple-500 pl-4">
            <p className="text-sm text-slate-600 mb-1">Active User Rate</p>
            <p className="text-2xl font-bold text-slate-900">
              {stats && stats.totalUsers > 0
                ? ((stats.activeUsersToday / stats.totalUsers) * 100).toFixed(1)
                : 0}%
            </p>
            <p className="text-xs text-slate-500 mt-1">Daily engagement</p>
          </div>
        </div>
      </div>
    </div>
